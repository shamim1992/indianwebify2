...
const PortfolioSection = () => {
  ...
  const projects = [
    { id: 1, title: 'MediConnect Portal', category: 'web', icon: <Globe className="w-6 h-6" />, description: 'A comprehensive healthcare portal for hospitals to manage patient records, appointments, and telemedicine services.', technologies: ['React', 'Node.js', 'MongoDB', 'Express'], link: '#', stats: { users: '5,000+', hospitals: '12', appointments: '250+ daily' } },
    { id: 2, title: 'ShopEase Mobile App', category: 'app', icon: <Smartphone className="w-6 h-6" />, description: 'A feature-rich e-commerce mobile application with personalized shopping experiences and secure payment integration.', technologies: ['React Native', 'Firebase', 'Redux', 'Stripe API'], link: '#', stats: { downloads: '25,000+', rating: '4.7/5', transactions: '1,200+ daily' } },
    { id: 3, title: 'GourmetBasket', category: 'ecommerce', icon: <ShoppingBag className="w-6 h-6" />, description: 'An online grocery platform with subscription services, recipe recommendations, and contactless delivery options.', technologies: ['WordPress', 'WooCommerce', 'PHP', 'MySQL', 'jQuery'], link: '#', stats: { products: '5,000+', customers: '15,000+', orders: '500+ daily' } },
    { id: 4, title: 'FinTrack Dashboard', category: 'ui', icon: <Code className="w-6 h-6" />, description: 'A modern financial analytics dashboard with intuitive visualizations and real-time data monitoring capabilities.', technologies: ['Figma', 'Adobe XD', 'Sketch', 'Illustrator'], link: '#', stats: { charts: '35+', users: '1,200+', dataPoints: '1M+ processed' } },
    { id: 5, title: 'TravelBuddy App', category: 'app', icon: <Smartphone className="w-6 h-6" />, description: 'A travel companion app with itinerary planning, local recommendations, and augmented reality navigation features.', technologies: ['Flutter', 'Dart', 'Google Maps API', 'Firebase'], link: '#', stats: { destinations: '1,500+', users: '45,000+', trips: '12,000+ planned' } },
    { id: 6, title: 'EduLearn Platform', category: 'web', icon: <Globe className="w-6 h-6" />, description: 'An educational platform with interactive courses, live sessions, and progress tracking for students and educators.', technologies: ['Angular', 'TypeScript', 'Node.js', 'MongoDB'], link: '#', stats: { courses: '250+', students: '35,000+', instructors: '120+' } },
    { id: 7, title: 'DineReserve System', category: 'web', icon: <Globe className="w-6 h-6" />, description: 'A restaurant reservation and management system with table planning, waitlist management, and customer profile features.', technologies: ['Vue.js', 'Laravel', 'MySQL', 'Twilio API'], link: '#', stats: { restaurants: '75+', reservations: '3,000+ weekly', users: '50,000+' } },
    { id: 8, title: 'FitTrack Wearable App', category: 'app', icon: <Smartphone className="w-6 h-6" />, description: 'A fitness tracking application for smartwatches and mobile devices with personalized workout plans and health analytics.', technologies: ['Swift', 'Kotlin', 'HealthKit', 'Google Fit API'], link: '#', stats: { users: '120,000+', workouts: '500+ types', data: '2TB+ processed' } },
    { id: 9, title: 'ArtGallery eCommerce', category: 'ecommerce', icon: <ShoppingBag className="w-6 h-6" />, description: 'An online marketplace for artists to showcase and sell their artwork with virtual gallery tours and artist profiles.', technologies: ['Shopify', 'React', 'AWS', 'Stripe'], link: '#', stats: { artists: '450+', artworks: '12,000+', sales: '$1.2M+ annually' } }
  ];
            ...
            {filters.map(filter => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center mx-1 ${
                  activeFilter === filter.id ? 'bg-[#6d123f] text-white' : 'hover:bg-gray-100'
                }`}
              >
            ...
            >
              <div className="bg-white rounded-xl shadow-xl overflow-hidden h-full transition-all duration-300 group-hover:shadow-2xl border border-gray-100">
                ...
                <div className="p-6 pt-8">
                  ...
                  <a href={project.link} target="_blank" rel="noopener noreferrer" className="flex items-center text-[#6d123f] font-medium text-sm group-hover:text-[#e6961d] transition-colors duration-300">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={closeModal}>
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-5xl w-full max-h-[90vh] overflow-y-auto animate-scale-in" onClick={(e) => e.stopPropagation()}>
            <div className="relative h-64 md:h-80 bg-gradient-to-r from-[#6d123f] to-[#e6961d]">
              ...
              <button onClick={closeModal} className="absolute top-4 right-4 w-10 h-10 rounded-full cursor-pointer bg-[#e6961d] hover:bg-[#6d123f] bg-opacity-20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-opacity-40 transition-all duration-300">
                <X size={20} />
              </button>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    {['Intuitive user interface and UX design', 'Responsive design for all device types', 'Advanced search and filtering capabilities', 'Real-time data synchronization', 'Secure user authentication system', 'Comprehensive analytics dashboard'].map((feature, i) => (
                  ...
                  <p className="text-gray-700 mb-6">This project successfully delivered a powerful solution that exceeded client expectations. Users reported a significant improvement in efficiency and satisfaction, while the client saw measurable business growth as a direct result of the implementation.</p>
                </div>
                ...
                <div className="md:col-span-1">
                  <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedProject.technologies.map((tech, i) => (
                            <span key={i} className="bg-white text-gray-700 text-xs px-3 py-1 rounded-full border border-gray-200">{tech}</span>
                          ))}
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <Star key={i} size={16} className="text-[#e6961d] fill-[#e6961d]" />
                          ))}
                  ...
                  <div className="mt-6">
                    <a href={selectedProject.link} target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-[#6d123f] text-white text-center rounded-xl font-medium flex items-center justify-center hover:bg-[#e6961d] transition-colors duration-300">
